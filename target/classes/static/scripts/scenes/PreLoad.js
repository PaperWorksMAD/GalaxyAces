...
export class PreLoad extends Phaser.Scene {
	...
	preload() {
		this.load.image("listo", "./resources/images/listo.png");
		this.load.image("rivalout", "./resources/images/rivalout.png");
		this.load.image("caido", "./resources/images/caido.png");
		...
		this.load.image("listobt", "./resources/images/listo.png");
		...
		this.load.image('naveAux', 'resources/images/Ship2.png');
		this.load.image('nave2', 'resources/images/Ship6.png');
		this.load.image('nave1', 'resources/images/Ship3.png');
		this.load.image('nave3', 'resources/images/Ship1.png');
